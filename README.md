...
Implementation tasks are tracked with Beans in [.beans/](/Users/daverapin/projects/gleam/scoreboard/.beans). Use `beans list --ready` to find work that is ready for an agent. The current intended routing and Mount context design is recorded in [docs/adr/0007-use-file-routes-route-kinds-and-mount-contexts.md](docs/adr/0007-use-file-routes-route-kinds-and-mount-contexts.md). Shared identity vocabulary is recorded in [docs/adr/0008-use-authentication-context-for-shared-identity.md](docs/adr/0008-use-authentication-context-for-shared-identity.md).
