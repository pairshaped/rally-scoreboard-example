//// Admin backend state and update loop.
////
//// Mirrors Lamdera-style server state for the admin Mount: the generated
//// WebSocket runtime sends ToServer messages here, then this module delegates
//// constructor dispatch to generated admin code.

import generated/admin/dispatch as generated_dispatch
import generated/admin/request_context.{type RequestContext}
import lustre/effect.{type Effect}
import server/admin/model.{type Model, Model}
