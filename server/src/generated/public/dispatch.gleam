...
////
//// Page-load constructors (LoadGames, LoadGame, LoadStandings, LoadTeam)
//// call the page module's unified `load` function. Command constructors
//// owned by this Mount call a handler whose name is the snake_case of the
//// constructor name. Handlers receive constructor fields as labeled args,
//// plus request_context, server_context, and backend_model.
////
