...
////
//// Page-load constructors (LoadAdminGames) call the page module's unified
//// `load` function. Command constructors owned by this Mount call a handler
//// whose name is the snake_case of the constructor name (CreateGame ->
//// create_game, UpdateScore -> update_score, MarkFinal -> mark_final,
//// CorrectResult -> correct_result). Handlers receive constructor fields
//// as labeled args, plus request_context, server_context, and
//// backend_model.
////
