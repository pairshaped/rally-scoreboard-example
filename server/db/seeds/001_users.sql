...
--
-- Admin:  admin@example.com / admin / code A1Z9Q / can_admin = 1
-- Fan:    fan@example.com   / fan  / code A1Z9Q / can_admin = 0

INSERT OR IGNORE INTO users (email, display_name, password_hash, sign_in_code_hash, can_admin)
VALUES
    (
        'admin@example.com',
        NULL,
