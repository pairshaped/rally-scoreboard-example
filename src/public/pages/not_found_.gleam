...
/// generated/proute/public/pages stores this inside NotFoundPage, while the page
/// delegates its concrete model shape to page_stub.
pub type Model =
  page_stub.Model

/// Proute page message for unmatched public routes.
/// generated/proute/public/pages wraps this as NotFoundMsg, while the page
/// delegates concrete messages to page_stub.
pub type Message =
  page_stub.Message

/// Proute page init function for unmatched public routes.
/// generated/proute/public/pages calls this when it constructs NotFoundPage.
pub fn init(
