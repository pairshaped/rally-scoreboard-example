...
Rally consuming Proute output should reduce authored routing code. User-authored modules should not import generated route modules just to perform page load, hydration, browser navigation, SSR, or broadcast dispatch. When those workflows need route or page identity, generated Rally glue should consume the generated Proute route and page modules directly.
